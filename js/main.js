...
class SendFormCalc {
  ...
  sendForm() {
    ...
    //если сообщение есть, удаляем мод. окно
    const popupNone = (form, popupWindow) => {
    ...
    this.elemDoc.callForm.addEventListener('submit', (event) => {
      ...
      popupNone(this.elemDoc.callForm, this.elemDoc.popupCall);
    });
    ...
    this.elemDoc.discountForm.addEventListener('submit', (event) => {
      ...
      popupNone(this.elemDoc.discountForm, this.elemDoc.popupDiscount);
    });
    ...
    this.elemDoc.checkForm.addEventListener('submit', (event) => {
      ...
      popupNone(this.elemDoc.checkForm, this.elemDoc.popupCheck);
    });
    ...
    this.elemDoc.consultationForm.addEventListener('submit', (event) => {
      ...
      popupNone(this.elemDoc.consultationForm, this.elemDoc.popupConsultation);
    });
    ...
    this.elemDoc.discountCalcForm.addEventListener('submit', (event) => {//отправка формы
      ...
      popupNone(this.elemDoc.discountCalcForm, this.elemDoc.popupDiscountCalc);
    });
